...
namespace GarmentStreet.DataAccess.Migrations
{
    ...
    [Migration("20230207100145_addOrderHeaderAndDetailsToDb")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GarmentStreet.Models.OrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GarmentStreet.Models.OrderHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GarmentStreet.Models.ShoppingCart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GarmentStreet.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("GarmentStreet.Models.OrderDetail", b =>
                {
                    b.HasOne("GarmentStreet.Models.Inventory", "Inventory")
                        .WithMany()
                        .HasForeignKey("InventoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GarmentStreet.Models.OrderHeader", "OrderHeader")
                        .WithMany()
            ...
            modelBuilder.Entity("GarmentStreet.Models.OrderHeader", b =>
                {
                    b.HasOne("GarmentStreet.Models.ApplicationUser", "ApplicationUser")
                        .WithMany()
